...
case when o.adid is null then 0 else 1 end as is_old_user
...
LEFT JOIN (SELECT DISTINCT adid FROM hive.qkslg_om_w.dws_user_info_di) o
on c.adid = o.adid
)
