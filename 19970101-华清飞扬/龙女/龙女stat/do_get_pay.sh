...
port=22
user=huntress
desdir=/data1/shushu/hutnress_vietnam_payment_orderid_history
password=huntress@97
...
#1.压缩
mysql -h10.148.0.22 -udragon -pdragongirl -N  -e "select 'payment', dragongirl.pay.*  from dragongirl.pay where time>='${day} 00:00:00' and time<= '${day} 23:59:59' and status = 0" -B -s | sed 's/\t/,/g' > ${tempdir}${todata}
