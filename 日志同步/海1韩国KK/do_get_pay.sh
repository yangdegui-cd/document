...
host=119.28.84.97
port=22
desdir=/data/logupload/ship/korea_kk/ship_korea_kk_payment_app
user='logupload'
password='upload@hq'
...
#1.压缩
mysql -h10.1.0.6 -uworldship -pworldship -Dworldship -N  -e "select * from pay where time>='${day} 00:00:00' and time<= '${day} 23:59:59'" -B -s | sed 's/\t/,/g' > ${tempdir}${todata}
