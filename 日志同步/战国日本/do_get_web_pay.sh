...
tempdir=/data/tmpdir/website_pay_list/
mkdir -p ${tempdir}
todata=paylist_website_${day}.data
echo 'start upload data:'${day}
#1.压缩
mysql  -hdow-mysql.cdsxxlgd4fbn.ap-northeast-1.rds.amazonaws.com -ustatreadonly -pdowHQjp0415 -Ddow  -N  -e "select *  from t_website_pay where time>='${day} 00:00:00' and time<= '${day} 23:59:59'" -B -s | sed 's/\t/,/g' > ${tempdir}${todata}
