...
host=119.28.41.240
port=22
desdir=/data1/warship/oumei/ship_oumei_payment_app
user='warship'
...
#1.压缩
mysql -h10.200.0.14 -uworldship -pworldship -Dworldship -N  -e "select * from pay where time>='${day} 00:00:00' and time<= '${day} 23:59:59'" -B -s | sed 's/\t/,/g' > ${tempdir}${todata}
