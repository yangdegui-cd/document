...
#1.压缩
mysql -h10.144.78.91 -ustat -p123456 -N  -e "select 'payment', game_warship.pay.*  from game_warship.pay where time>='${day} 00:00:00' and time<= '${day} 23:59:59'" -B -s | sed 's/\t/,/g' > ${tempdir}${todata}
