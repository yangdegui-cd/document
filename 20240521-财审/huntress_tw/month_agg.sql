...
WHERE NOT EXISTS (SELECT 1
                  FROM hive.huntress_tw_w.dws_audit_daily_di dt
                  WHERE ds.date = dt.date)
ORDER BY ds.date;

-- dwd_gserver_diamondcost_live
-- dwd_gserver_additem_live
-- dws_audit_daily_di
-- dws_user_daily_di
-- dws_user_info_df05
...
from hive.huntress_tw_w.dws_audit_daily_di
...
itemadd_daily_array
from hive.huntress_tw_w.dws_audit_daily_di
where part_date >= '2024-01-01' and part_date <= '2024-06-30'
)
