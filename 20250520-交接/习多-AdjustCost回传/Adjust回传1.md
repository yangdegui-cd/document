...
```bash
cd /data/web/statisticsgoogleadweb/configs #更新 logback-spring.xml
cd /data/web/statisticsgoogleadweb/lib     #更新 lib包
sh /data/web/statisticsgoogleadweb/bin/shutdown.sh  #重启服务
sh /data/web/statisticsgoogleadweb/bin/start.sh  #重启服务
```
