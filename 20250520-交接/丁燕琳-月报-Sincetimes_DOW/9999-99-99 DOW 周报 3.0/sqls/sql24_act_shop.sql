...
* @Last Modified time: 2025-02-17 11:44:48
*/
...
-- and payment_item_id in ('gold_324', 'gold_325', 'gold_326', 'gold_327', 'gold_328', 'gold_329', 'gold_330', 'gold_331', 'gold_332', 'gold_333')
...
item_select1 as(
select part_date, date(part_date) as date, d.act_tag, 
'获得道具' as type, coalesce(b.pay_tag, '未活跃') as pay_tag, 
...
item_select2 as(
select part_date, date(part_date) as date, d.act_tag, 
'获得道具渠道' as type, coalesce(b.pay_tag, '未活跃') as pay_tag, 
a.role_id, concat(reason_cn, '_', reason_subid) as dis_type1, e.item_name as dis_type2, item_num as target_sum
from hive.dow_jpnew_r.dwd_gserver_itemchange_live a
left join month_tag b
on a.role_id = b.role_id
left join hive.dow_jpnew_w.dim_gserver_addgold_reason c
