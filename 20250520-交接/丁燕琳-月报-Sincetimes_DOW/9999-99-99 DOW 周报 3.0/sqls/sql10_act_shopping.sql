...
* @Last Modified time: 2025-02-17 11:41:45
*/
...
corechange_agg as(
select part_date, date(part_date) as date, role_id, 
sum(coalesce(free_num, 0) + coalesce(paid_num, 0))/500 as gold_paid
...
item_agg as(
select part_date, date(part_date) as date, role_id, 
count(distinct event_time) as open_count
...
b.act_rmb, b.act_paycount, d.open_count, c.gold_paid, 
...
a.core_add, a.core_cost, a.core_end, 
a.sincetimes_add, a.sincetimes_cost, a.sincetimes_end, 
a.act_rmb, a.act_paycount, a.open_count, a.gold_paid, 
