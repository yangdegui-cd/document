...
* @Last Modified time: 2025-02-17 11:41:28
*/
...
item_select2 as(
select part_date, date(part_date) as date, d.act_tag, 
'道具获得2' as type, coalesce(b.pay_tag, '未活跃') as pay_tag, 
a.role_id, reason_id as dis_type1, reason_cn as dis_type2, item_num as target_sum
from hive.dow_jpnew_r.dwd_gserver_itemchange_live a
left join month_tag b
on a.role_id = b.role_id
left join hive.dow_jpnew_w.dim_gserver_addgold_reason c
...
left join act_tag d
on date(a.part_date) = d.date
where payment_item_id in('gold_376', 'gold_377', 'gold_378', 'gold_379', 'gold_380')
and b.is_test is null
), 
