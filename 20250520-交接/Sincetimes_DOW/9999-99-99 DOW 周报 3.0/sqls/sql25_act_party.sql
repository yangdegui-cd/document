...
* @Last Modified time: 2025-04-29 14:47:36
*/
...
sum(case when payment_item_id in('gold_375', 'gold_371', 'gold_372', 'gold_373', 'gold_374', 'gold_60078', 'gold_60079', 'gold_60080', 'gold_60081', 'gold_60082', 'gold_60083', 'gold_60084') then coalesce(rawmoney, 0) * 0.052102 + coalesce(sincetime_money, 0) else null end) as act_rmb, 
sum(case when payment_item_id in('gold_505', 'gold_506') then coalesce(rawmoney, 0) * 0.052102 + coalesce(sincetime_money, 0) else null end) as bp_rmb
