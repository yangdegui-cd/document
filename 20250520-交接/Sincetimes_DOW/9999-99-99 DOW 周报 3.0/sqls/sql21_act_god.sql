...
* @Last Modified time: 2025-02-17 11:43:59
*/
...
sum(case when b.payment_act = '神武锻造' then coalesce(rawmoney, 0) * 0.052102 + coalesce(sincetime_money, 0) else null end) as act_rmb
...
sum(case when event_type = 'cost' then item_num/2 else null end) as summon_count, 
