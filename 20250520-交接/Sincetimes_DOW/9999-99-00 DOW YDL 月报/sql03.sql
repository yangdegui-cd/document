...
sum(rawmoney_rmb) as current_money
from log_info a
...
a.goods_cate, 
a.current_money, 
b.current_money as last1_money, 
c.current_money as last2_money, 
row_number() over(partition by a.first_of_month, a.goods_cate, z.constant_tag order by a.uid) as rn
from payment_info a
left join payment_info b
on a.uid = b.uid and a.goods_cate = b.goods_cate and a.last1_month = b.first_of_month
left join payment_info c
on a.uid = c.uid and a.goods_cate = c.goods_cate and a.last2_month = c.first_of_month
left join monthly_tag z
on a.uid = z.uid and a.first_of_month = z.first_of_month
)

select a.first_of_month, a.last1_month, 
a.uid, a.vip_level, a.vip_tag, 
a.current_tag, a.last1_tag, a.next1_tag, a.constant_tag, a.currentconstant_tag, 
-- a.last1_tagindex, a.next1_tagindex, a.current_tagindex, 
a.status, a.status_change, a.constant_status, 
-- a.next_status, a.nextstatus_change, 
a.goods_cate, 
a.current_money, a.last1_money, a.last2_money, 
b.mau, 1 as is_pay
from res a
left join mau_info b
on a.first_of_month = b.first_of_month 
and a.last1_tag = b.last1_tag
and rn = 1