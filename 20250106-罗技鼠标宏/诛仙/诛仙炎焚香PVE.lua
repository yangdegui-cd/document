...
-- 咒焚香pvp
-- release_skills = {
--     {skill_name = "灵火炙魂", is_break = true},
--     {skill_name = "缚邪", is_break = true},
--     {skill_name = "聚烁", is_break = true},
--     {skill_name = "灵引", is_break = false},
...
release_skills = {
	...
	{	
		...
		can_release = function() 
			return not isCooling("炎龙刻印") and not isCooling("意气风发")
		end,
	...
	{skill_name = "南巫天火",is_break = true}
	{	
		skill_name = "灵火炙魂", 
		is_break = true,
	 	after_released = function() 
	 		if lhzh_reduce_cd
				skills["南巫天火"].final_release -= 2000 
			end
		end
	},
	{skill_name = "驭火诀",is_break = true},
	{	
		skill_name = "焚秽", 
		is_break = true,
	 	after_released = function() 
	 		if fh_reduce_cd
				skills["驭火诀"].final_release -= 2000 
			end
		end
	},
}
