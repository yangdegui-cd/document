WITH AdjustCost AS
     ...
     UserInstallTag AS
         (SELECT "#user_id",
                 max(case when cluster_name = 'da_install_ts' then tag_value_tm else null end) as install_at
          FROM ta.user_result_cluster_36
          GROUP BY 1),
...
where e.ad_cost != ResultTable.ad_cost
