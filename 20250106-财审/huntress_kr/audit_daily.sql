...
###  
create table if not exists hive.huntress_krnew_w.dws_audit_daily_di
(date date,
role_id varchar,
channel varchar,
money bigint,
...
delete from hive.huntress_krnew_w.dws_audit_daily_di where part_date >= '{beginning_of_month}' and part_date <= '{end_of_month}';

insert into hive.huntress_krnew_w.dws_audit_daily_di
...
part_date
from hive.huntress_krnew_r.dwd_gserver_corechange_live
where part_date >= '{beginning_of_month}' and part_date <= '{end_of_month}'
and event_type = 'cost'
...
part_date
from hive.huntress_krnew_r.dwd_gserver_itemchange_live a
left join hive.huntress_krnew_w.dim_gserver_audit_item b
